...
<body>
    ...
    <div class="space-room">
        <div class="room">
            <h2 class="titles wow bounceInDown" data-wow-delay="0.5s" data-wow-duration=".5s">交换空间·智能全房整装</h2>
            <p class="title-b wow bounceInDown" data-wow-delay="0.4s" data-wow-duration=".5s">一站式家装服务平台，真正的拎包入住</p>
            <ul class="server-show">
                <li class="server-list wow bounceInUp" data-wow-delay="0.4s" data-wow-duration=".8s">
            ...
            <p class="btn-group">
                <a href="#" class="more btn-style wow bounceInRight" data-wow-delay="1s" data-wow-duration="1s">更多详情</a>
                <span data-layer="1" class="visit-btn show-btn btn-style wow bounceInLeft" data-wow-delay="1s" data-wow-duration="1s">预约参观</span>
            </p>
        </div>
    </div>
    <!-- 全屋空间实景配置 begin -->
    <div class="deploy">
        ...
        <div class="deploy-group">
            <ul class="deploy-tab wow bounceInRight" data-wow-delay="0.5s" data-wow-duration="1s">
                <li class="tab-list tab-list-active">
                    <span>北欧尚品</span>
                </li>
                <li class="tab-list">
                    <span>现代时尚</span>
            ...
            <div class="carousel-group wow bounceInUp" data-wow-delay="0.5s" data-wow-duration=".8s">
                <div class="ban-group">
                            ...
                            <ul class="de-content">
                                <li class="de-list delist01">
                                    <ul class="de-list-content">
                                        <li>
                                            <span>配置：</span>三房两厅一厨两卫 </li>
                                        <li>
                                            <span>面 积：</span>123㎡</li>
                                        <li>
                                            <span>造价：</span>约16.8万</li>
                                        <li>
                                            <span>主材：</span>德国骆驼屋地板、骆驼瓷砖、艾饰壁纸、金格橱柜、德斯朗诺卫浴等</li>
                                        <li>
                                            <span>电器：</span>老板抽油烟机、老板灶具、美的12L燃气热水器、净之泉净水器等</li>
                                    </ul>
                                    <ul class="de-list-content">
                                        <li>全房家具：</li>
                                        <li>
                                            <span>客厅：</span>沙发1+2+3、茶几、电视柜、鞋柜；</li>
                                        <li>
                                            <span>餐厅：</span>餐桌、4把餐椅；</li>
                                        <li>
                                            <span>主卧：</span>1.8米床、双床头柜、四门衣柜；</li>
                                        <li>
                                            <span>次卧：</span>1.5米床、双床头柜、三门衣柜；</li>
                                        <li>
                                            <span>书房：</span>书桌、书椅。</li>
                                    </ul>
                                </li>
    ...
    <!-- 关于我们 begin -->
    <div class="about">
        <div class="about-con wow bounceInRight" data-wow-delay="0.5s" data-wow-duration=".8s">
            <h3 class="wow bounceInDown" data-wow-delay="0.8s" data-wow-duration="1s">公司简介</h3>
            <p class="wow bounceInUp" data-wow-delay="0.8s" data-wow-duration="1s">交换空间装饰，央视网黄金展位合作伙伴；室内装饰企业施工贰级资质；北京室内装饰协会会员单位，荣获北京绿色装饰企业，交换空间品牌创建于2005年7月27日，交换空间装饰行业唯一合法注册商标。12年来，交换空间以其时尚的设计理念和精湛的施工工艺、科学的规范管理、全程的无忧服务、良好的道德口碑享誉全国大江南北，据不完全统计，交换空间品牌受众群体已超过十万人。</p>
        </div>
    </div>
    <!-- 关于我们 end -->
    <!-- 行业资讯 begin -->
    <div class="news">
        <div class="news-con">
            ...
            <div class="swiper-container news-container wow bounceInUp" id="news" data-wow-delay="1s" data-wow-duration="1s">
                        ...
                        <ul class="news-group">
                            <li class="news-list nl-lt">
                                ...
                                <div class="news-info">
                                    ...
                                    <p>
                                        <a href="#">怎么装修让卧室生活更具情调-卧室壁灯装修效果图</a>
                                    </p>
                                </div>
                                <i class="bot-line"></i>
                            </li>
