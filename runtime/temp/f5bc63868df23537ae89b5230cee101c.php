<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\xampp\htdocs\qbl\public/../application/index\view\regin\editcity.html";i:1525310619;s:70:"D:\xampp\htdocs\qbl\public/../application/index\view\index\header.html";i:1525256581;s:70:"D:\xampp\htdocs\qbl\public/../application/index\view\index\footer.html";i:1524022637;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div style="padding: 15px;">
        <form class="layui-form layui-form-pane1" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="c_name" id="c_name" value="<?php echo $city['c_name']; ?>" lay-verify="required|c_name" required placeholder="请输入城市名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <?php if(is_array($quality) || $quality instanceof \think\Collection || $quality instanceof \think\Paginator): $i = 0; $__LIST__ = $quality;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$qua): $mod = ($i % 2 );++$i;?>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" style="width: 300px;" name="c_q_price" required placeholder="请输入平米单价,单位：（元）" autocomplete="off" value="<?php echo $qua['price']; ?>" class="layui-input c_q_price">
                    </div>
                </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <div class="layui-form-item">
