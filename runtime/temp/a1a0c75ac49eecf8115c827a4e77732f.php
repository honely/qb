<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\xampp\htdocs\qbl\public/../application/index\view\example\edit.html";i:1525937283;s:71:"D:\xampp\htdocs\qbl\public/../application/index\view\indexs\header.html";i:1525742386;s:71:"D:\xampp\htdocs\qbl\public/../application/index\view\indexs\footer.html";i:1525742360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="case_b_id" id="branch" lay-verify="required">
                                        ...
                                        <option value="<?php echo $vos['b_id']; ?>" <?php if($vos['b_id'] == $case['case_b_id']): ?>selected<?php endif; ?>><?php echo $vos['b_name']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
