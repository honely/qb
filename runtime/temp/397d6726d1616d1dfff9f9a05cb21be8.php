<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\xampp\htdocs\qbl\public/../application/index\view\article\editarticle.html";i:1525516094;s:70:"D:\xampp\htdocs\qbl\public/../application/index\view\index\header.html";i:1525663540;s:70:"D:\xampp\htdocs\qbl\public/../application/index\view\index\footer.html";i:1524022637;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-body">
    <blockquote class="layui-elem-quote">编辑文章</blockquote>
    <div class="layui-tab">
                        ...
                        <form class="layui-form" action="<?=url('article/editArticle')?>?art_id=<?php echo $art['art_id']; ?>" method="post">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="art_title" value="<?php echo $art['art_title']; ?>" lay-verify="required|title" placeholder="请输入文章标题" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item layui-form-text">
                                <label class="layui-form-label">子标题</label>
                                <div class="layui-input-block">
                                    <textarea placeholder="请输入子标题" name="art_subtitle" class="layui-textarea"><?php echo $art['art_subtitle']; ?></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="art_type" lay-verify="required" lay-filter="art_type">
                                        ...
                                        <option value="1" <?php if($art['art_type'] == '1'): ?>selected<?php endif; ?> >媒体资讯</option>
                                        <option value="2" <?php if($art['art_type'] == '2'): ?>selected<?php endif; ?> >装修知识</option>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-upload">
                                    ...
                                    <div class="layui-upload-list" style="margin-left: 60px;">
                                        <img class="layui-upload-img" style="height: 210px;width: 350px" src="__PUBLIC__<?php echo $art['art_img']; ?>" id="logoPre">
                                    </div>
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="art_img_alt" value="<?php echo $art['art_img_alt']; ?>" lay-verify="required|title" placeholder="请输入图片alt" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">文章内容</label>
                                <div class="layui-input-block">
                                    <textarea id="demo" placeholder="请输入文章内容" name="art_content" style="display: none;"><?php echo $art['art_content']; ?></textarea>
                                </div>
                            ...
                            <div class="layui-form-item" pane>
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="art_isable" value="1" title="是" <?php if($art['art_isable'] == '1'): ?>checked<?php endif; ?> >
                                    <input type="radio" name="art_isable" value="2" title="否" <?php if($art['art_isable'] == '2'): ?>checked<?php endif; ?> >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">SEO标题</label>
                                <div class="layui-input-block">
                                    <input type="text" name="art_seo_title" value="<?php echo $art['art_seo_title']; ?>" lay-verify="required|title" placeholder="请输入SEO标题" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">SEO关键词</label>
                                <div class="layui-input-block">
                                    <input type="text" name="art_seo_keywords" value="<?php echo $art['art_seo_keywords']; ?>" lay-verify="required|title" placeholder="请输入SEO关键词,多个关键词之间用英文逗号隔开。" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item layui-form-text">
                                <label class="layui-form-label">SEO描述</label>
                                <div class="layui-input-block">
                                    <textarea placeholder="请输入SEO描述" name="art_seo_desc" class="layui-textarea"><?php echo $art['art_seo_desc']; ?></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <div class="layui-input-block">
