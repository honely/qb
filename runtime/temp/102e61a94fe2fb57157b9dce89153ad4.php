<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\xampp\htdocs\qbl\public/../application/index\view\admin\editrole.html";i:1525768361;s:71:"D:\xampp\htdocs\qbl\public/../application/index\view\indexs\header.html";i:1525742386;s:71:"D:\xampp\htdocs\qbl\public/../application/index\view\indexs\footer.html";i:1525742360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form class="layui-form" id="addRoles" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="hidden" value="<?php echo $roleInfo['r_id']; ?>" id="r_id"/>
                ...
                <div class="layui-colla-item">
                    <h2 class="layui-colla-title">
                        <input type="checkbox" class="checkParents checks"
                            <?php if(is_array($m_ids) || $m_ids instanceof \think\Collection || $m_ids instanceof \think\Paginator): $i = 0; $__LIST__ = $m_ids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;if($items == $menu['m_id']): ?>checked<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        lay-filter="checkAll" value="<?php echo $menu['m_id']; ?>" lay-skin="primary" /><?php echo $menu['m_name']; ?></h2>
                    <div class="layui-colla-content layui-show">
                        <div class="layui-collapse">
                            ...
                            <div class="layui-colla-item">
                                <h2 class="layui-colla-title">
                                    <input class="checkChild checks" type="checkbox" lay-filter="checkFun" value="<?php echo $child['m_id']; ?>"
                                     <?php if(is_array($m_ids) || $m_ids instanceof \think\Collection || $m_ids instanceof \think\Paginator): $i = 0; $__LIST__ = $m_ids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($item == $child['m_id']): ?>checked<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                    lay-skin="primary" />
                                    <?php echo $child['m_name']; ?>
                                </h2>
                                <div class="layui-colla-content layui-show">
                                    <?php if(is_array($child['children']) || $child['children'] instanceof \think\Collection || $child['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $child['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$children): $mod = ($i % 2 );++$i;?>
                                        <input type="checkbox" class="checkFun checks"
                                               <?php if(is_array($m_ids) || $m_ids instanceof \think\Collection || $m_ids instanceof \think\Paginator): $i = 0; $__LIST__ = $m_ids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itemss): $mod = ($i % 2 );++$i;if($itemss == $children['m_id']): ?>checked<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                        value="<?php echo $children['m_id']; ?>" lay-skin="primary" />
                                        <?php echo $children['m_name']; endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
