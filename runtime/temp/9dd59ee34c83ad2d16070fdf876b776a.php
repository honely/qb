<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\xampp\htdocs\qbl\public/../application/index\view\topics\add.html";i:1525744232;s:71:"D:\xampp\htdocs\qbl\public/../application/index\view\indexs\header.html";i:1525742386;s:71:"D:\xampp\htdocs\qbl\public/../application/index\view\indexs\footer.html";i:1525742360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-tab-item layui-show">
                <div style="margin: 10px">
                    <div style="padding: 15px;">
                        <form class="layui-form" action="<?=url('topics/add')?>" method="post">
                            <div class="layui-form-item">
                                <label class="layui-form-label">专题名称2</label>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    ...
                                    <a class="layui-btn layui-btn-primary" href="<?=url('topics/topics')?>">返回</a>
                                </div>
                            </div>
                        </form>
                    </div>
