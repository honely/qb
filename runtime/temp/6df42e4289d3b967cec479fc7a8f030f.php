<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\xampp\htdocs\qbl\public/../application/xian\view\xian\design.html";i:1526120424;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="UTF-8"/>
...
<script type="text/javascript" src="__XIAN__/js/slide.min.js"></script>
...
<div class="l-yuan">
	<div class="l-banner">
		<div class="w1200">
			<div class="l-from">
				<h3>抢领免费设计名额</h3>
					<form id="freeDesign" enctype='multipart/form-data'>
						...
						<button class="l-btn" id="freeOrder" type="button">免费获取全屋设计方案</button>
					</form>
...
                        
	...
	<div class="l-y-con">
		...
		<div class="l-fwlc w1200">
			...
			<ul>
				<li>
				<span>01</span>
				<i class="fr"><img src="__XIAN__/img/icon1.png"/></i>
				<font class="fl">电话安排<br/>量房时间</font>
				</li>
				<li>
				<span>02</span>
				<i class="fr"><img src="__XIAN__/img/icon2.png"/></i>
				<font class="fl">专业设计<br/>上门量房</font>
				</li>
				<li>
				<span>03</span>
				<i class="fr"><img src="__XIAN__/img/icon3.png"/></i>
				<font class="fl">三个工作日<br/>出设计图</font>
				</li>
				<li>
				<span>04</span>
				<i class="fr"><img src="__XIAN__/img/icon4.png"/></i>
			...
			<div class="l-lycon">
				<div class="w1200">
					<ul>
						<li>
						<span>
						<img src="__XIAN__/img/free1.png"/>
						</span>
						<p>
								第一步 户型图
						</p>
						...
						<li class="odd">
						<span>
						<img src="__XIAN__/img/free2.png"/>
						</span>
						<p>
								第二步 效果图
						</p>
						...
						<li class="ldd">
						<span>
						<img src="__XIAN__/img/free3.png"/>
						</span>
						<p>
								第三步 实景图
						</p>
			...
			<div class="l-dzsjt">
				...
				<div class="l-dbtow w1200">
					<ul>
						<li class="fl">
						<span></span>
						<img src="__XIAN__/img/free4.png"/>
						<p>
						根据您的户型+风格+预算定制设计图
						</p>
						</li>
						<li class="fr">
						<span></span>
						<img src="__XIAN__/img/free5.png"/>
						<p>
						效果不满意？免费修改不用愁
						</p>
						</li>
					...
					<div id="slide3d" class="slide-carousel slide-3d">
						<ul class="item-list clearfix">
							...
							<div class="item-content">
								...
								<img class="cover-img" src="__XIAN__/img/wn.jpg" alt="">
							</div>
							</li>
							<li class="item1">
							<div class="item-content">
								...
								<img class="cover-img" src="__XIAN__/img/wjt.jpg" alt="">
							</div>
							</li>
							<li class="item2">
							<div class="item-content">
								...
								<img class="cover-img" src="__XIAN__/img/ytq.jpg" alt="">
							</div>
							</li>
							<li class="item3">
							<div class="item-content">
								...
								<img class="cover-img" src="__XIAN__/img/fl.jpg" alt="">
							</div>
							</li>
						</ul>
						<!--indicators-->
			...
			<div class="l-lx-fw">
				...
				<div class="l-lxcon w1200">
					<div class="fl">
						...
						<div class="fr">
							<p>
								<img src="__XIAN__/img/r2.png"/>
								<font>
									1cm以下误差
								</font>
							</p>
							<p>
								<img src="__XIAN__/img/r3.png"/>
								<font>
									70项指标
								</font>
							</p>
			...
			<div class="lBase fl">
				...
				<div class="base ove">
					...
					公司地址：陕西省西安市未央区辛家庙地铁C口千百炼&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="http://xian.qblzs.com.cn/mobile/" target="_blank">手机版</a>手机版</a>&nbsp;|&nbsp;<a href="<?=url('xian/contact')?>">联系我们</a><!--&nbsp;|&nbsp;<a href="sitemap.html">网站地图</a>&nbsp;|&nbsp;-->
	...
	<div class="layer-tc" style="display: none;">
		<form enctype='multipart/form-data' id="oneToOne">
			...
			<button class="lay-btn" type="button" id="toOneOrder">点击预约</button>
		</form>
	</div>
	<!-- 底部浮动表单 -->
<div class="float-box">
        <div class="form-fixed">
            <ul>
                ...
                <li class="f-form">
                    <form class="form" id="designFloat" enctype='multipart/form-data'>
                        <input type=hidden name=ecmsfrom value="/"> 
                        <input name='enews' type='hidden' value='AddFeedback'>
                        ...
                        <input type="button" id="designOrder" class="subtn" value="立即预约"/>
                    </form>   
                </li>
