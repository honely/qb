<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\xampp\htdocs\qbl\public/../application/index\view\admin\edit.html";i:1525771374;s:71:"D:\xampp\htdocs\qbl\public/../application/index\view\indexs\header.html";i:1525742386;s:71:"D:\xampp\htdocs\qbl\public/../application/index\view\indexs\footer.html";i:1525742360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div style="padding: 15px;">
        <form class="layui-form layui-form-pane1" action="<?=url('admin/edit')?>?ad_id=<?php echo $admin['ad_id']; ?>" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="ad_c_id" lay-verify="required" id="bu_c_id" lay-filter="bu_c_id">
                        ...
                        <?php if(is_array($city) || $city instanceof \think\Collection || $city instanceof \think\Paginator): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cit): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $cit['c_id']; ?>" <?php if($admin['ad_c_id'] == $cit['c_id']): ?>selected<?php endif; ?> ><?php echo $cit['c_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="ad_branch" id="branch" lay-verify="required">
                        ...
                        <?php if(is_array($bran) || $bran instanceof \think\Collection || $bran instanceof \think\Paginator): $i = 0; $__LIST__ = $bran;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $item['b_id']; ?>" <?php if($admin['ad_branch'] == $item['b_id']): ?>selected<?php endif; ?>><?php echo $item['b_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="ad_phone" value="<?php echo $admin['ad_phone']; ?>" lay-verify="required|phone" placeholder="请输入手机号码" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">电子邮箱</label>
                <div class="layui-input-block">
                    <input type="text" name="ad_email" value="<?php echo $admin['ad_email']; ?>" lay-verify="required|email" placeholder="请输入手机号码" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
