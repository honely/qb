<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\xampp\htdocs\qbl\public/../application/xian\view\index\contact.html";i:1526032399;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--[if IE 8 ]>
  ...
  <div class="select-hover" style="position: absolute;background: #fff;top:35px;left:120px;border:1px solid #fff;">
    ...
    <div class="Column">
    <p class="leader fl">
    <a href="/">首页</a><i>&nbsp;&gt;&nbsp;</i><a href="<?=url('index/about')?>">关于我们</a>
    </p>
    <ul class="list fr">
    <li class="inline"><a href="<?=url('index/about')?>">公司简介</a></li>
     
    <li class="inline"><a href="<?=url('index/contact')?>" class="current">联系我们</a></li>
    </ul>
    </div>
    </div>
