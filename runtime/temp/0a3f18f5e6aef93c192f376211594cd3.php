            ...
            <div class="layui-tab-item layui-show">
                <div style="margin: 10px">
                    ...
                    <table class="layui-table" lay-filter="parse-table-demo" style="padding: 10px;text-align: center;border: 1px;solid-color: #28282c">
                        ...
                        <?php endif; if(is_array($design) || $design instanceof \think\Collection || $design instanceof \think\Paginator): $i = 0; $__LIST__ = $design;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$na): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td><?php echo $na['des_id']; ?></td>
                            <td><?php echo $na['des_name']; ?></td>
