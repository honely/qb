<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\xampp\htdocs\qbl\public/../application/index\view\index\login.html";i:1525340980;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="login">
    <h2>后台管理系统</h2>
    <form class="layui-form" method="post" action="<?=url('index/login')?>">
